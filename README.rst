...
This repository contains examples scripts that can be run in Aalto
University's Triton-cluster, but it will be useful to others as well.
...
https://github.com/AaltoSciComp/hpc-examples and embedded into
